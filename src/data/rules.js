  ...
  stage_01: {
    ...
    steps: {
      brainstorm: {
        ...
        baseOptions: {
          warm_template: { progress: 35, effects: { time: 2, token: 0, risk: 1, quality: 2 } },
      ...
      plan: {
        ...
        baseOptions: {
          light_outline: { progress: 35, effects: { time: 2, token: 0, risk: 1, quality: 2 } },
        ...
        skillOptions: {
          spec_doc: { progress: 50, effects: { time: 2, token: 1, risk: -2, quality: 3 } },
      ...
      execute: {
        ...
        skillOptions: {
          tdd_guard: { progress: 50, effects: { time: 2, token: 1, risk: -3, quality: 4 } },
      ...
      review: {
        ...
        baseOptions: {
          manual_check: { progress: 40, effects: { time: 3, token: 0, risk: 3, quality: 1 } },
        ...
        skillOptions: {
          code_review_final: { progress: 60, effects: { time: 2, token: 1, risk: -5, quality: 5 } },
    ...
    emergencyStep: {
      options: {
        emergency_hotfix: { effects: { time: 3, token: 0, risk: -4, quality: 1 } },
        emergency_ai_patch: { effects: { time: 0, token: 4, risk: -1, quality: -1 } },
      },
      skillOptions: {
        emergency_escalation_path: { effects: { time: 2, token: 2, risk: -3, quality: 1 } },
