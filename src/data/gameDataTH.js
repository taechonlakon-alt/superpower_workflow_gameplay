  ...
  "steps": [
    {
          ...
          "skillOptions": [
            {
              ...
              "solves": "แก้ปัญหาเฟสปัจจุบัน · ใช้ Skill แก้ปัญหาเฉพาะจุด · ลดความเสี่ยง",
      ...
      "baseOptions": [
        ...
        },
        {
          ...
          "solves": "เพิ่มคุณภาพและหลักฐานอ้างอิง · งานเดินหน้า",
      ...
      "skillOptions": [
        {
          ...
          "solves": "ใช้ Skill แก้ปัญหาเฉพาะจุด · ลดความเสี่ยง · เพิ่มคุณภาพและหลักฐานอ้างอิง",
      ...
      "synergyOptions": [
        {
          ...
          "solves": "ใช้ Combo ปิดหลายช่องโหว่ · ลดความเสี่ยง · เพิ่มคุณภาพและหลักฐานอ้างอิง",
          ...
          "options": [
            {
              ...
              "problem": "หลีกหนีกับดักความซับซ้อน",
              "purpose": "ปล่อย AI ร่างงานกว้างๆ ไปก่อน โด·ี่ยังไม่กำหนดไฟล์, เทสต์, ลำดับ, และการตรวจสอบ",
      ...
      "baseOptions": [
        {
          ...
          "solves": "ลดความเสี่ยง · เพิ่มคุณภาพและหลักฐานอ้างอิง",
    ...
    },
    {
      ...
      "baseOptions": [
        ...
        },
        {
          ...
          "solves": "เร่งการทำงานแต่ความเสี่ยงเพิ่มขึ้น",
          "misses": "ความเสี่ยงสูงอาจทำให้เกิดปัญหาในเฟส / สร้างหนี้ทางคุณภาพ / ใช้ AI Budget เยอะมาก / กินเวลาเดดไลน์ที่มี"
        },
        {
          "id": "manual_build",
          ...
          "solves": "ลดความเสี่ยง · เพิ่มคุณภาพและหลักฐานอ้างอิง · งานเดินหน้า",
          "misses": "กินเวลาเดดไลน์ที่มี"
        },
        {
    ...
    },
    {
      ...
      "baseOptions": [
        ...
        },
        {
          ...
          "misses": "ความเสี่ยงสูงอาจทำให้เกิดปัญหาในเฟส / สร้างหนี้ทางคุณภาพ"
        }
      ],
      "skillOptions": [
        {
  ...
  "emergencyStep": {
    ...
    "baseOptions": [
      ...
      },
      {
        ...
        "solves": "ลดความเสี่ยง",
        "misses": "ลดคุณภาพงานลง / ใช้ AI Budget เยอะมาก"
      }
    ],
    "skillOptions": [
      {
...
function defaultChoiceSolves(option) {
  ...
  let solves = [];
  if (effects.quality > 0) solves.push("เพิ่มคุณภาพงานที่ส่งมอบ");
  if (effects.risk < 0) solves.push("ลดความเสี่ยงโปรเจกต์");
  if (effects.time < 0) solves.push("ช่วยประหยัดเวลา/เดดไลน์");
  if (effects.token < 0) solves.push("ช่วยประหยัด AI Budget");

  return solves.join(" + ") || option.tradeoff || "จัดการกับคำขอเฉพาะหน้า";
}

function defaultChoiceMisses(option) {
  const effects = option.effects || {};
  let misses = [];
  if (effects.risk > 0) misses.push("เพิ่มความเสี่ยงซ่อนเร้น");
  else if (effects.quality < 0) misses.push("ลดคุณภาพงานลง");
  if (effects.token >= 3) misses.push("ใช้ AI Budget เยอะมาก");
  if (effects.time >= 3) misses.push("กินเวลาเดดไลน์ที่มี");

  return misses.join(" / ") || option.tradeoff || "ยังต้องการการตรวจสอบภายหลัง";
}
